...
from gg_bond_code.state.context import (
    ToolUseContext,
    create_store_context,
    create_subagent_context,
    _noop_set_state,
)
from gg_bond_code.state.store import _Store, reset_store
from gg_bond_code.permissions.manager import PermissionManager, PermissionDecision
from gg_bond_code.tools.base import ToolRegistry
...
def test_create_store_context_custom_permissions():
    ...
    with patch("gg_bond_code.state.context.PermissionManager") as MockPM:
