...
from gg_bond_code.commands.types import CommandResult, CommandContext, ResultType
from gg_bond_code.commands.clear import handle_clear
from gg_bond_code.commands.compact import handle_compact
from gg_bond_code.commands.help import handle_help
from gg_bond_code.commands.thinking import handle_thinking
from gg_bond_code.commands.model import handle_model
from gg_bond_code.commands.exit import handle_exit
...
class TestHelpHandler:
    def test_help_lists_commands(self):
        registry = CommandRegistry()
        from gg_bond_code.commands.exit import create as create_exit
        from gg_bond_code.commands.model import create as create_model
