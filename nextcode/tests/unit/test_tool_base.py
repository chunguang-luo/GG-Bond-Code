...
from next_code.tools.base import Tool, ToolResult, ToolRegistry
...
def test_builtin_read_only_tools():
    ...
    from next_code.tools.file_read import FileReadTool
    from next_code.tools.glob import GlobTool
    from next_code.tools.grep import GrepTool
...
def test_builtin_write_tools_not_read_only():
    ...
    from next_code.tools.bash import BashTool
    from next_code.tools.file_edit import FileEditTool
    from next_code.tools.file_write import FileWriteTool
