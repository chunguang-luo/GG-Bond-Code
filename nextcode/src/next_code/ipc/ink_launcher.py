...
def _find_frontend_bundle() -> Path | None:
    ...
    Search order:
    1. Relative to the Python package (src/next_code/frontend/dist/)
    2. Walk up from __file__ to find a nextcode/frontend/dist/ directory
    ...
    #    Typical: src/next_code/ipc/ink_launcher.py
    #    Target:  nextcode/frontend/dist/index.js
