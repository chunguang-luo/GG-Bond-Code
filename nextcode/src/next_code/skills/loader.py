...
The loader reads each Skill file, parses its frontmatter, converts it into
a PromptCommand via ``create_skill_command()``, and returns the list.
"""
...
async def _load_skill_file(
    ...
    """Load a single Skill file and convert it to a Command.
